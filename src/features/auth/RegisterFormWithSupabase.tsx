...
export const RegisterFormWithSupabase = ({ onSuccess }: RegisterFormWithSupabaseProps) => {
  ...
  const handleSubmit = async (values: RegisterFormValues) => {
    console.log("📝 Soumission inscription Supabase:", values.email);
            ...
            <div className="space-y-2">
              ...
              {registrationSuccess.needsEmailConfirmation ? (
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-medium">Cliquez sur le lien dans l'email pour finaliser votre inscription et accéder à votre espace.</p>
