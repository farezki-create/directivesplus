      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="w-[80px]"></div> {/* Pour équilibrer le titre */}
          </div>
          ...
          <div className="space-y-6">
            {currentLanguage === 'fr' ? (
              <>
                <Card className="overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <h2 className="text-xl font-semibold text-blue-700 mb-4">Que sont les directives anticipées ?</h2>
                ...
                <Card className="overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <h2 className="text-xl font-semibold text-blue-700 mb-4">Qui peut rédiger des directives anticipées ?</h2>
                    <p className="text-gray-700">
                ...
                <Card className="overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <h2 className="text-xl font-semibold text-blue-700 mb-4">Comment rédiger des directives valides ?</h2>
                    <p className="text-gray-700">
                ...
                <Card className="overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <h2 className="text-xl font-semibold text-blue-700 mb-4">Quels éléments doivent figurer dans le document ?</h2>
                    <p className="mb-4 text-gray-700">Les directives doivent préciser :</p>
                    ...
                    <h3 className="font-semibold mt-4 mb-2 text-blue-600">Aspects pratiques</h3>
                  </CardContent>
                </Card>

                <Card className="overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <h2 className="text-xl font-semibold text-blue-700 mb-4">Où conserver ses directives anticipées ?</h2>
                    <p className="mb-4 text-gray-700">Trois lieux de conservation principaux sont préconisés :</p>
                ...
                <Card className="overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <h2 className="text-xl font-semibold text-blue-700 mb-4">Comment mettre à jour ses directives ?</h2>
                    <p className="text-gray-700">
                ...
                <Card className="overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <h2 className="text-xl font-semibold text-blue-700 mb-4">Un médecin peut-il refuser d'appliquer mes directives ?</h2>
                    <p className="mb-4 text-gray-700">Oui dans deux cas précis :</p>
                    <ol className="list-decimal pl-6 mb-4 space-y-2 text-gray-700">
                    ...
                    <p className="mb-4 text-gray-700">Dans ce second cas, le médecin doit obligatoirement :</p>
                    <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
                ...
                <Card className="overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <h2 className="text-xl font-semibold text-blue-700 mb-4">Dois-je obligatoirement désigner une personne de confiance ?</h2>
                    <p className="mb-4 text-gray-700">
                ...
                <Card className="overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <h2 className="text-xl font-semibold text-blue-700 mb-4">Où trouver de l'aide pour rédiger ?</h2>
                    <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
              ...
              // Version anglaise (à compléter ultérieurement)
              <Card className="overflow-hidden shadow-md">
                <CardContent className="p-6">
                  <h2 className="text-xl font-semibold text-blue-700 mb-4">What are advance directives?</h2>
                  <p className="text-gray-700">
                    English content will be displayed here when the English language is selected.
                    Please switch to French to view the complete FAQ content.
                  </p>
                  <Button 
                    variant="outline" 
                    className="mt-4"
