...
const TestimonialForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div>
        <Label htmlFor="title">Titre de votre témoignage</Label>
        <Input
          id="title"
      ...
      <div>
        ...
        <Textarea
          id="content"
          {...register('content', { 
            required: "Le contenu du témoignage est requis",
            minLength: {
              value: 20,
              message: "Votre témoignage doit contenir au moins 20 caractères"
            }
          })}
