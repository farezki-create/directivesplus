...
-- Supprimer la table existante et la recréer correctement
DROP TABLE IF EXISTS public.user_otp;
...
CREATE INDEX IF NOT EXISTS idx_user_otp_email_used ON public.user_otp(email, used);
