...
-- Supprimer et recréer complètement la table user_otp avec la structure correcte
DROP TABLE IF EXISTS public.user_otp CASCADE;

-- Créer la table user_otp avec tous les champs requis
...
-- Politique RLS pour permettre l'accès via service role
